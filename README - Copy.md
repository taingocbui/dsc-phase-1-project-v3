...
The goal of this project is to interpret aviation data from the National Transportation Safety Board to recommend the safest aircraft to support the company's investment in operating airplanes in commercial and private enterprises.
...
## 3. Data Overview and Safety Measure

The table has 31 columns and 90348 data points, storing worldwide aviation accidents. It not only includes airplanes' accidents data, but also other aircraft categories such as helicopter, balloon, gyrocraft, etc. 

## 4. Data Cleaning

The main tools used in this project for data cleaning and data transformation is Python's Pandas library. For the visualization part, I use both matplotlib and Pyplot to build various line charts, bar charts, and heat maps. 

## 5. Data Exploration and Safety Measure Methodology
